...
public class CompositeApiConstants extends NLS {

	public static final String BUNDLE_NAME = "compositeApi_constants";
	...
	public static String PROJECT_NATURE;
